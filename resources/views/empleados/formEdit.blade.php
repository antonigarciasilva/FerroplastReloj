    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="javascript:void(0)" enctype="multipart/form-data" method="POST" id="FormularioEdicion">
...
<script>
    function actualizarEmpleado() {
        ...
        var formData = new FormData($(FormularioEdicion)[0]);
        ...
        $.ajax({
            data: {
                ...
                Foto: document.getElementById('Foto_edit'),
            },
